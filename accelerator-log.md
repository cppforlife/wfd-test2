...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dynamicMsgBroker":true,"dbType":"mysql","enableCloudEvents":false,"empty":"","enableSecurity":false,"gatewayType":"ossscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"dynamicDBClass":"mysql-unmanaged","secureProfile":"secure","artifactId":"wfd","dynamicDatabase":true,"serviceNamespace":"apps","msgBrokerType":"rabbitmq","projectName":"wfd","workloadNamespace":"apps","cacheType":"inmemCache","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input7743412192356762347, --data-values-file, /tmp/accelerator-options16468829607307688778.json, --output-files, /tmp/ytt-output4879470009440510572]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dynamicMsgBroker":true,"dbType":"mysql","enableCloudEvents":false,"empty":"","enableSecurity":false,"gatewayType":"ossscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"dynamicDBClass":"mysql-unmanaged","secureProfile":"secure","artifactId":"wfd","dynamicDatabase":true,"serviceNamespace":"apps","msgBrokerType":"rabbitmq","projectName":"wfd","workloadNamespace":"apps","cacheType":"inmemCache","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input6099630363537039739, --data-values-file, /tmp/accelerator-options573994738685515623.json, --output-files, /tmp/ytt-output8404149695319183477]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dynamicMsgBroker":true,"dbType":"mysql","enableCloudEvents":false,"empty":"","enableSecurity":false,"gatewayType":"ossscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"dynamicDBClass":"mysql-unmanaged","secureProfile":"secure","artifactId":"wfd","dynamicDatabase":true,"serviceNamespace":"apps","msgBrokerType":"rabbitmq","projectName":"wfd","workloadNamespace":"apps","cacheType":"inmemCache","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input5513081158135603420, --data-values-file, /tmp/accelerator-options8042871024852617593.json, --output-files, /tmp/ytt-output2917256522863348671]
